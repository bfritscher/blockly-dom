...
Blockly.JavaScript["body_element"] = function(block) {
  return ["document.body", Blockly.JavaScript.ORDER_ATOMIC];
};
...
Blockly.JavaScript["set_content"] = function(block) {
  ...
  return element + "." + block.getFieldValue("TYPE") + " = " + value + ";\n";
};
...
Blockly.JavaScript["handle_event"] = function(block) {
  ...
  var variable_element = Blockly.JavaScript.variableDB_.getName(
...
Blockly.JavaScript["handle_mouse_move"] = function(block) {
  ...
  var variable_x = Blockly.JavaScript.variableDB_.getName(
    block.getFieldValue("x"),
    Blockly.Variables.NAME_TYPE
  );
  var variable_y = Blockly.JavaScript.variableDB_.getName(
...
Blockly.JavaScript["handle_key_press"] = function(block) {
  ...
  var variable_key = Blockly.JavaScript.variableDB_.getName(
...
Blockly.JavaScript["get_json"] = function(block) {
  var url = Blockly.JavaScript.valueToCode(
    block,
    "URL",
    Blockly.JavaScript.ORDER_ATOMIC
  );
  var json = Blockly.JavaScript.variableDB_.getName(
    block.getFieldValue("JSON"),
    Blockly.Variables.NAME_TYPE
  );
...
Blockly.JavaScript["dicts_set_item"] = function(block) {
  ...
  var value_dict = Blockly.JavaScript.valueToCode(
    block,
    "DICT",
    Blockly.JavaScript.ORDER_ATOMIC
  );
...
Blockly.JavaScript["dicts_get_item"] = function(block) {
  ...
  var dict = Blockly.JavaScript.valueToCode(
    block,
    "DICT",
    Blockly.JavaScript.ORDER_ATOMIC
  );
...
Blockly.JavaScript["dicts_controls_foreach"] = function(block) {
  ...
  var variable_value = Blockly.JavaScript.variableDB_.getName(
...
Blockly.Blocks["dicts_has_key"] = {
  init: function() {
    this.appendValueInput("DICT").setCheck(null);
    this.appendValueInput("KEY")
      .setCheck("String")
      .appendField("has key");
    this.setInputsInline(true);
...
Blockly.Blocks["dicts_to_list"] = {
  init: function() {
    this.appendValueInput("DICT")
      ...
      .appendField(
        new Blockly.FieldDropdown([["keys", "keys"], ["values", "values"]]),
        "TYPE"
      )
      .appendField("from");
    this.setInputsInline(true);
